...
function hsl.set(c) love.graphics.setColor(util.color255To1(hsl.convert(c.h, c.s, c.l, c.a))) end

--Set the color used for drawing using 255 as alpha amount
function hsl.setOpaque(c) love.graphics.setColor(util.color255To1(hsl.convert(c.h, c.s, c.l, 255))) end

--Set the color used for drawing using 0 as alpha amount
function hsl.setTransp(c) love.graphics.setColor(util.color255To1(hsl.convert(c.h, c.s, c.l, 0))) end
